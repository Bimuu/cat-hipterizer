...
data_00 = np.load('/kaggle/working/dataset/CAT_00.npy',allow_pickle=True)
data_01 = np.load('/kaggle/working/dataset/CAT_01.npy',allow_pickle=True)
data_02 = np.load('/kaggle/working/dataset/CAT_02.npy',allow_pickle=True)
data_03 = np.load('/kaggle/working/dataset/CAT_03.npy',allow_pickle=True)
data_04 = np.load('/kaggle/working/dataset/CAT_04.npy',allow_pickle=True)
data_05 = np.load('/kaggle/working/dataset/CAT_05.npy',allow_pickle=True)
...
y_train = np.concatenate((data_00.item().get(mode), data_01.item().get(mode), data_02.item().get(mode), data_03.item().get(mode), data_04.item().get(mode)), axis=0)

x_test = np.array(data_05.item().get('imgs'))
y_test = np.array(data_05.item().get(mode))
